  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="space-y-10">
        ...
        <section>
          <SectionHeader eyebrow="Section 01" title="Account Info" />
          <Card className="p-6">
        ...
        {/* Section 2: Contacts */}
        <section>
          <SectionHeader eyebrow="Section 02" title="Contacts" />
          <Card className="overflow-hidden">
            {/* Lucas Oil Rep — higher-prominence subgroup */}
            ...
            {/* Customer Contacts — visually secondary subgroup */}
        ...
        {/* Section 3: Financial */}
        <section>
          <SectionHeader eyebrow="Section 03" title="Financial" />
